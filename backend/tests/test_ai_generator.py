...
class TestAIGenerator:
    ...
    def test_generate_response_with_tool_calling(self, mock_anthropic_class):
        ...
        mock_final_response.content = [Mock(text="Based on the search results, Python is a programming language.")]
    ...
    def test_generate_response_tool_execution_error(self, mock_anthropic_class):
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.return_value = "Tool execution failed: Database connection error"
...
class TestAIGeneratorIntegration:
    ...
    def test_integration_with_real_tool_manager(self, mock_anthropic_class):
        ...
        mock_final_response = Mock()
        mock_final_response.stop_reason = "end_turn"
        mock_final_response.content = [Mock(text="Python is a versatile programming language.")]
